...
If(isset($_POST["btn_sub"]))
{
	...
	$insqry="insert into tbl_complaint(complainttype_id,complaint_content,customer_id,booking_id,complaint_date) values('".$complaint_type."','".$complaintcontent."','".$_SESSION['customerid']."','".$_GET['bid']."',curdate())";
