...
include("../Asset/Connection/Connection.php");
  include("Head.php");                                     
    ...
    inner join tbl_cart ca on ca.booking_id=b.booking_id inner join tbl_complainttype t on c.complainttype_id=t.complainttype_id where c.customer_id=".$_SESSION['customerid'];
