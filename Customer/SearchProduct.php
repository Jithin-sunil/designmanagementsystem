...
<div aria-live="polite" aria-atomic="true" class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
    ...
    <div class="filters" id="sidebar">
        ...
        ?>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="<?php echo $data['productcategory_id']; ?>" id="category<?php echo $data['productcategory_id']; ?>" name="category" onchange="gettype(this.value),getSearch()">
                <label class="form-check-label" for="category<?php echo $data['productcategory_id']; ?>">
                    <?php echo $data['productcategory_name']; ?>
                </label>
            </div>
        <?php
        }
    ...
    $.ajax({
        url: "../Asset/AjaxPages/AjaxSearchType.php?category=" + category,
        method: "GET",
        ...
        function getSearch() {
            ...
            $.ajax({
                url: "../Asset/AjaxPages/AjaxSearchProduct.php?search="+searchKeyword+"&category="+category+"&type="+type,
                method: "GET",
                success: function (response) {
