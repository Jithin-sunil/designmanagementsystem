...
<html>
    ...
    <?php
        ...
        if (isset($_POST["btn_checkout"])) {
                ...
                $selC = "select * from tbl_booking where customer_id='" .$_SESSION["customerid"]. "'and booking_status='0'";
                $rs = mysql_query($selC);
                $row=mysql_fetch_array($rs);
                
                $upQry1 = "update tbl_booking set booking_date=curdate(),booking_amount='".$amt."',booking_status='1' where customer_id='" .$_SESSION["customerid"]. "'";
				mysql_query($upQry1);
...
<form method="post">
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
             $sel = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id where b.customer_id='" .$_SESSION["customerid"]. "' and booking_status='0' and cart_status=0";
            $res = mysql_query($sel);
            ...
            <div class="product">
                <div class="product-image">
                    <img
                        src="../Asset/File/Product/<?php echo $rowpr
                        ["product_image"]?>"
                        />
                </div>
                ...
                <div class="product-price "	><?php echo $rowpr["product_prize"] ?></div>
